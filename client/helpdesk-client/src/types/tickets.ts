...
export interface SupportUserResponse{id:string;displayName:string;roles:string[]}
export interface ChangeTicketStatusRequest{statusId:number;note?:string|null}
export interface CancelTicketRequest{reason?:string|null}
...
export interface TicketDetailResponse extends TicketSummaryResponse{description:string;resolvedAtUtc:string|null;closedAtUtc:string|null;comments:TicketCommentResponse[];attachments:TicketAttachmentResponse[];assignmentHistory:TicketAssignmentResponse[];statusHistory:TicketStatusHistoryResponse[]}
