...
export interface ReportSummary{totalTickets:number;openTickets:number;terminalTickets:number;cancelledTickets:number;assignedTickets:number;unassignedTickets:number}
