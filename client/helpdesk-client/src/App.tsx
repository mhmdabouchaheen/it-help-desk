...
export default function App(){return <Routes><Route element={<PublicOnlyRoute/>}><Route path="/login" element={<LoginPage/>}/><Route path="/register" element={<RegisterPage/>}/></Route><Route element={<ProtectedRoute/>}><Route path="/app" element={<AppLayout/>}><Route index element={<Navigate to="home" replace/>}/><Route path="home" element={route(<HomePage/>)}/><Route path="tickets" element={route(<TicketListPage/>)}/><Route path="tickets/new" element={route(<CreateTicketPage/>)}/><Route path="tickets/:id" element={route(<TicketDetailPage/>)}/><Route path="tickets/:id/edit" element={route(<EditTicketPage/>)}/><Route path="notifications" element={route(<NotificationsPage/>)}/></Route></Route><Route path="/" element={<Navigate to="/app/home" replace/>}/><Route path="*" element={<NotFoundPage/>}/></Routes>}
